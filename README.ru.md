...
Клиент — **Next.js** (TipTap), страницы A4, DOCX, оболочка **Tauri**. Writer-copilot понимает структуру книги (главы → сцены → персонажи), ищет нестыковки в сюжете и может править любую сцену проекта, не только открытую.
...
| **Лента + A4** | Вкладки ленты, вёрстка страницы, DOCX в обе стороны. |

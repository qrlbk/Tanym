...
Клиент — **Next.js** (TipTap), лента стиліндегі редактор, DOCX, **Tauri** қабы. Writer-copilot кітап құрылымын түсінеді, сюжетті тексереді және жобаның кез келген сценасын өңдей алады.
...
| **Лента + DOCX** | Таныс лента, DOCX екі бағытта да. |
